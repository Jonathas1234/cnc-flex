...
export function Localizacao() {
  const mapsUrl = "https://www.google.com/maps/search/?api=1&query=CNC+Flex+Av+Casa+Verde+3434+São+Paulo+SP";
  const info = [
  ...
  return (
    <section className="py-28 bg-[#f7f8fa] overflow-hidden" id="contato">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[55%_45%] gap-8">
          <motion.div initial={{opacity:0,x:-30}} whileInView={{opacity:1,x:0}} viewport={{once:true}}>
            <div className="w-full overflow-hidden border border-white/60 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.06)]" style={{height:"100%",minHeight:"420px"}}>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.0!2d-46.6753!3d-23.4937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDI5JzM3LjMiUyA0NsKwNDAnMzEuMSJX!5e0!3m2!1spt-BR!2sbr!4v1234567890"
                width="100%" height="100%" style={{border:0,minHeight:"420px"}} allowFullScreen loading="lazy" title="Localização CNC Flex"/>
            </div>
          </motion.div>
          <motion.div initial={{opacity:0,x:30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{delay:0.15}}>
            ...
            <div className="space-y-3 mb-8">
              {info.map((it,i)=>{
                const card = (
                  <div className="flex items-start gap-3.5 p-4 bg-white/60 backdrop-blur-lg border border-white/70 active:bg-white/90 hover:bg-white/80 hover:shadow-[0_8px_24px_rgba(10,60,110,0.08)] rounded-xl transition-all duration-500 cursor-pointer"
                    style={{boxShadow:"0 4px 16px rgba(0,0,0,0.03), 0 1px 0 rgba(255,255,255,0.8) inset"}}>
                    <div className="w-9 h-9 flex-shrink-0 flex items-center justify-center rounded-xl backdrop-blur-sm" style={{background:`${it.c}10`,border:`1px solid ${it.c}20`}}><it.icon size={16} style={{color:it.c}}/></div>
                ...
                return it.href
                  ? <a key={i} href={it.href} target="_blank" rel="noopener noreferrer" className="block">{card}</a>
                  : <div key={i}>{card}</div>;
              })}
            </div>
            <a href="https://wa.me/5511938023558?text=Olá!%20Gostaria%20de%20falar%20com%20um%20especialista%20da%20CNC%20Flex" target="_blank" rel="noopener noreferrer"
              className="w-full py-4 flex items-center justify-center gap-2.5 text-[13px] font-bold tracking-[0.1em] uppercase bg-[#25D366] text-white rounded-xl transition-all duration-300 active:brightness-90 hover:brightness-110 shadow-[0_4px_16px_rgba(37,211,102,0.3)]">
