        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-8">
          ...
          <motion.div initial={{opacity:0,x:30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{delay:0.15}}>
            ...
            <div className="space-y-3 mb-8">
              {info.map((it,i)=>{
                const card = (
                  <div className="flex items-start gap-3.5 p-4 bg-white/60 backdrop-blur-lg border border-white/70 hover:bg-white/80 hover:shadow-[0_8px_24px_rgba(10,60,110,0.08)] rounded-xl transition-all duration-500 cursor-pointer"
            ...
            <motion.a href="https://wa.me/5511938023558?text=Olá!%20Gostaria%20de%20falar%20com%20um%20especialista%20da%20CNC%20Flex" target="_blank" rel="noopener noreferrer"
              className="w-full py-4 flex items-center justify-center gap-2.5 text-[13px] font-bold tracking-[0.1em] uppercase bg-[#25D366] text-white rounded-xl transition-all duration-300 hover:brightness-110 shadow-[0_4px_16px_rgba(37,211,102,0.3)]"
