...
export function WhatsAppButton() {
  return (
    <motion.a href="https://wa.me/5511938023558" target="_blank" rel="noopener noreferrer"
      ...
      <div className="absolute right-full mr-3 px-3 py-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity bg-[#0A3C6E] text-white/80 text-[11px] font-medium rounded-sm pointer-events-none shadow-lg">Fale Conosco</div>
    </motion.a>
  );
}
