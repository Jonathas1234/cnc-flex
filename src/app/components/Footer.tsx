      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
            ...
            <div className="flex gap-2">
              {[
                ...
                <motion.a key={i} href={url} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 flex items-center justify-center border border-white/20 text-white/60 rounded-sm transition-all duration-300"
          ...
          <div>
            ...
            <ul className="space-y-3">{navLinks.map(l=>(
              <li key={l.label}><a href={l.href} onClick={(e)=>{e.preventDefault();go(l.href)}}
                className="text-[14px] text-white/70 hover:text-white transition-colors cursor-pointer">{l.label}</a></li>
            ))}</ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="https://maps.google.com/?q=Av.+Casa+Verde+3434+São+Paulo" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group">
                <MapPin size={14} className="text-[#F38104] mt-0.5 shrink-0"/><span className="text-[14px] text-white/70 leading-relaxed group-hover:text-white transition-colors">Av. Casa Verde, 3434-C<br/>São Paulo - SP</span>
              </a></li>
              <li><a href="tel:+551139510270" className="flex items-center gap-3 group">
                <Phone size={14} className="text-[#F38104] shrink-0"/><span className="text-[14px] text-white/70 group-hover:text-white transition-colors">(11) 3951-0270</span>
              </a></li>
              <li><a href="mailto:cncflex@cncflex.com.br" className="flex items-center gap-3 group">
                <Mail size={14} className="text-[#F38104] shrink-0"/><span className="text-[14px] text-white/70 group-hover:text-white transition-colors">cncflex@cncflex.com.br</span>
              </a></li>
            </ul>
          </div>
        </div>
        <div className="pt-8 border-t border-white/[0.1] flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-5">
            <a href="#" className="text-[12px] text-white/50 hover:text-white/70 transition-colors">Privacidade</a>
            <a href="#" className="text-[12px] text-white/50 hover:text-white/70 transition-colors">Termos</a>
          </div>
        </div>
      </div>
    </footer>
