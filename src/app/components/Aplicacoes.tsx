      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="text-center mb-10 sm:mb-16">
          <motion.div className="flex items-center justify-center gap-3 mb-4" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            ...
            <span className="text-[11px] sm:text-[12px] font-semibold tracking-[0.2em] uppercase text-[#0A3C6E]">Segmentos</span>
            <div className="w-8 h-[1px] bg-[#0A3C6E]" />
          </motion.div>
          ...
          {items.map((it, i) => {
            ...
            return (
              <motion.div
                ...
                className="group p-4 sm:p-8 bg-white/60 backdrop-blur-lg hover:bg-[#0A3C6E] active:bg-[#0A3C6E] border border-white/70 hover:border-[#0A3C6E] active:border-[#0A3C6E] text-center cursor-pointer transition-all duration-500 rounded-xl relative overflow-hidden"
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-5 flex items-center justify-center rounded-xl bg-[#0A3C6E]/8 group-hover:bg-white/15 group-active:bg-white/15 border border-[#0A3C6E]/10 group-hover:border-white/20 group-active:border-white/20 transition-all duration-500">
                  <Icon size={18} className="text-[#0A3C6E] group-hover:text-white group-active:text-white transition-colors duration-500" />
                </div>
                ...
                <p className="text-[12px] sm:text-[14px] text-[#0f1419]/55 group-hover:text-white/70 group-active:text-white/70 font-light leading-relaxed transition-colors duration-500 hidden sm:block">{it.desc}</p>
